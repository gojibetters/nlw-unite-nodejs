...
CREATE TABLE "new_check_ins" (
    ...
    CONSTRAINT "check_ins_attende_id_fkey" FOREIGN KEY ("attende_id") REFERENCES "attendees" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
INSERT INTO "new_check_ins" ("attende_id", "created_at", "id") SELECT "attende_id", "created_at", "id" FROM "check_ins";
